...
{
    public partial class HomeworkGeoMapLabel : System.Web.UI.Page
    {
        public DataTable dt;
       ...
       protected void Page_Load(object sender, EventArgs e)
        {
            ...
            sql+=" ((b.c_deathyear<=1279 and  b.c_birthyear>=1127) or (b.c_deathyear>=1127 and b.c_birthyear<=1279)) and c.x_coord is not null and c.y_coord is not null";
            ...
            try
            {
               ...
               // personnumber = dt.Rows.Count;
                foreach (DataRow dr in dt.Rows)
                {
                   ...
                   jsstirng += string.Format(@"{{name:'{0}',geoCoord:[{1}, {2}]}},", dr["c_name_chn"].ToString(), dr["x_coord"].ToString(), dr["y_coord"].ToString());
                   if (dr["c_name_chn"].ToString() == "呂祖謙" || dr["c_name_chn"].ToString() == "伯恭" || dr["c_name_chn"].ToString() == "成"|| dr["c_name_chn"].ToString() == "東萊先生")
                    {
